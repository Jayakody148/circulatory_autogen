...
|---|---|---|---|
| `genetic_algorithm` | 1.4171e-03 | 1397.9 | 0.0359 |
| `CMA-ES` | 1.4413e+02 | 51.5 | 4.0000 |
| `multi_start (FD)` | 1.1306e-03 | 289.5 | 0.0272 |
| `multi_start (CasADi AD)` | 6.9049e-06 | 204.9 | 0.0020 |
| `multi_start (Myokit FSA)` | 1.5981e-06 | 43.6 | 0.0015 |
...
| method | best cost | time (s) | max param err |
|---|---|---|---|
| `genetic_algorithm` | 4.3336e-03 | 4359.7 | 0.0215 |
| `CMA-ES` | 1.0816e-04 | 380.3 | 0.0232 |
| `multi_start (Myokit FSA)` | 2.5432e-06 | 2133.2 | 0.0012 |
| `multi_start (CasADi bdf)` | 1.5012e-05 | 1188.3 | 0.0036 |
...
| method | best cost | time (s) | max param err |
|---|---|---|---|
| `genetic_algorithm` | 8.0606e-04 | 141.3 | 0.0086 |
| `CMA-ES` | 2.3941e-04 | 84.4 | 0.0159 |
| `multi_start (FD)` | 9.1452e-15 | 45.3 | 0.0000 |
| `multi_start (Myokit FSA)` | 1.5193e-13 | 46.5 | 0.0000 |
| `multi_start (CasADi AD)` | 1.3147e-12 | 73.9 | 0.0000 |
...
| method | best cost | time (s) | max param err |
|---|---|---|---|
| `genetic_algorithm` | 2.3036e-03 | 39.9 | 0.0639 |
| `CMA-ES` | 9.5099e-09 | 5.3 | 0.0003 |
| `multi_start (FD)` | 3.2838e-15 | 38.2 | 0.0000 |
| `multi_start (Myokit FSA)` | 3.5621e-15 | 644.0 | 0.0000 |
