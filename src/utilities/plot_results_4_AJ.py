...
# flow rate through A_common_hepatic_C_T
axs[0,0].plot(t, y[0][0] * conversion_mL, color='blue')
axs[0,0].set_ylabel('Flow Rate [mL/s]')
axs[0,0].set_xlim([200, 230])
axs[0,0].set_ylim(bottom=0,top=25)
axs[0,0].set_title('liver')

# flow rate through A_left_gastric_C_T
axs[0,1].plot(t, y[1][0] * conversion_mL, color='blue')
axs[0,1].set_ylabel('Flow rate [mL/s]')
axs[0,1].set_xlim([200, 230])
axs[0,1].set_ylim(bottom=0,top=25)
axs[0,1].set_title('stomach')

# flow rate through A_renal_L_T
axs[1,0].plot(t, y[2][0] * conversion_mL, color='blue')
axs[1,0].set_ylabel('Flow Rate [mL/s]')
axs[1,0].set_xlim([200, 230])
axs[1,0].set_ylim(bottom=0,top=25)
axs[1,0].set_title('kidney(L)')

# flow rate through A_splenic_C_T
axs[1,1].plot(t, y[3][0] * conversion_mL, color='blue')
axs[1,1].set_ylabel('Flow Rate [mL/s]')
axs[1,1].set_xlim([200, 230])
axs[1,1].set_ylim(bottom=0,top=25)
axs[1,1].set_title('spleen')
...
plt.savefig(os.path.join(output_file_path, 'plot_v16-3.png'))
plt.savefig(os.path.join(output_file_path, 'plot_v16-3.eps'))
