...
file_path = "/hpc/ajay148/CA_user/haemorrhage_models/haemorrhage_v6/generated_models/haemorrhage_v6/haemorrhage_v6.cellml"
...
y = sim_object.get_results(['A_common_hepatic_C_leak_T/q_lost', 'A_common_hepatic_C_T/q_T', 'heart/q_lv', 'A_aortic_arch_C_1/u'])
...
axs[0,0].plot(t, y[0][0]*conversion_mL)#, label='A_common_hepatic_C_leak_T/q_lost')
