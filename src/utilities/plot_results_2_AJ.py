...
haemorrhage_path = "/hpc/ajay148/CA_user/haemorrhage_models/haemorrhage_v7/generated_models/haemorrhage_v7/haemorrhage_v7.cellml"
output_file_path = "/people/ajay148/Downloads/temp plots"
...
# --- Label all x-axes and fix axis limits ---
for ax in axs.flat:
    ax.set_xlabel('Time [s]')
    ax.set_xlim(left=0)   # x-axis minimum at 0
    ax.set_ylim(bottom=0) # y-axis minimum at 0

# --- Add dashed line at 120s (onset of haemorrhage) ---
for ax in axs.flat:
    ax.axvline(x=120, color='gray', linestyle='--', linewidth=1, alpha=0.7)

# --- Adjust layout and save ---
plt.subplots_adjust(wspace=0.5, hspace=0.5)
plt.savefig(os.path.join(output_file_path, 'combined_transition_plot_4.png'))
plt.savefig(os.path.join(output_file_path, 'combined_transition_plot_4.eps'))
