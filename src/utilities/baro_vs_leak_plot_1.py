...
# P_AR
axs[1,1].plot(t, y[3][0] * conversion_mmHg, color='blue')
...
plt.savefig(os.path.join(output_file_path, 'plot_v15-5.png'))
plt.savefig(os.path.join(output_file_path, 'plot_v15-5.eps'))
